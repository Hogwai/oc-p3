...
/**
 * AbstractHandler: classe mère (IAHandler / UtilisateurHandler)
 * @author Lilian
 */
public abstract class AbstractHandler {
     ...
     * @see AbstractHandler#setCombinaison(List)
     * @see AbstractHandler#getCombinaison()
     */
    LinkedList<Integer> combinaison;

    /**
     * Mode
     * @see AbstractHandler#getMode()
     */
    ModeName mode;
